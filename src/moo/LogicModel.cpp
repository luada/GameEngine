...
#include "AnimationSceneLightInfo.h"
...
#define MAX_DELTA_HEIGHT 550.0f
    ...
    {
        MM::TerrainTypeInfos* typeInfos = mSystem->getTerrainTypeInfos();
        if (!typeInfos)
            return false;
    ...
    float LogicModel::getAnimationLength(const String& animName) const
    {
        ...
        Skill *skillTemplate = MM::EffectManager::getSingleton().getSkill(animName);
