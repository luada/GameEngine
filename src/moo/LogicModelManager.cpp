/********************************************************************
filename:   LogicModelManager.cpp
...
template<> MM::LogicModelManager * Ogre::Singleton<MM::LogicModelManager>::ms_Singleton = 0;

namespace
{
	class MM::LogicModelManager;

	class LogicModelControllerValue : public Ogre::ControllerValue<float>
	{
	protected:
		MM::LogicModelManager* mLogicModelMgr;

	public:
		LogicModelControllerValue(MM::LogicModelManager* mgr)
			: mLogicModelMgr(mgr)
		{
		}
...
namespace MM	{
    ...
    public:
        TerrainCollider(MM::TerrainData* terrainData, Ogre::Real scale)
	...
	LogicModelManager::LogicModelManager( MM::System *system ) :
	mSystem(system),
	mAutoNamedModel(0),
