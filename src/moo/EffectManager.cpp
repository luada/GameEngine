...
template<> MM::EffectManager * Ogre::Singleton<MM::EffectManager>::ms_Singleton = 0;
...
#define OUTPUT_DEBUG_INFO 1
	...
	{
		Skill *skillTemplate = MM::EffectManager::getSingleton().getSkill(skillName);
