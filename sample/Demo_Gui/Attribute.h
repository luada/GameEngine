...
#define DECLARE_ATTRIBUTE_FIELD(name, type, setter) \
	...
	{ \
		template <typename FieldType> \
		_name(FieldType* OwnerType::* offset, const ValueType& value) : \
			AttributeField<OwnerType, ValueType, SetterType>(offset, value) { } \
	}


#define ATTRIBUTE_FIELD(attribute, class, field, value) \
	struct _attribute##_##_field \
	{ \
		_attribute##_##_field() \
		{ \
			static attribute::_attribute<_class> Bind(&_class::_field, value); \
		} \
	} _attribute##_##_field
...
#define DECLARE_ATTRIBUTE_CLASS(name, type) \
	...
	{ \
		name(const ValueType& value) : \
			ClassAttribute<name<Type>, ValueType>(value) { } \
	}


#define ATTRIBUTE_CLASS(attribute, class, value) \
	class _class; \
