#ifndef __INPUT_DEFINE_H__
#define __INPUT_DEFINE_H__
...
namespace GUI
{
	...
	struct GUI_EXPORT MouseButton
	{
		...
		//@ExportToLua
		MouseButton(Enum value = None) : value(value) { }

		//@ExportToLua
		bool operator == (MouseButton const& other)
		{
	...
	struct GUI_EXPORT KeyCode
	{
		...
		//@ExportToLua
		KeyCode(Enum value = None) : value(value) { }

		//@ExportToLua
		bool operator == (KeyCode const& other)
		{
			return value == other.value;
		}
