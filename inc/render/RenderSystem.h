...
#include "ccom/TDNode.h"
#include "ccom/TDGfxSystem.h"
#include "ccom/TDMath.h"
#include "ccom/TDEventSystem.h"
...
protected:
	...
	//地形网格
	MM::TerrainGrid* m_pTerrainGrid;
	//鼠标射线和场景交集
	Ogre::RaySceneQuery	*m_pRaySceneQuery;
	//PostFilter系统(全局渲染器)
	MM::PostFilterManager* m_pPostFilterManager;
	//环境特效
	MM::EnviromentObject*  m_pEnviromentObject;
...
public:
	//得到渲染系统
	MM::System*		GetRenderSystem(VOID) { return m_pRenderSystem; }
	//游戏坐标与渲染坐标之间的放缩比例
